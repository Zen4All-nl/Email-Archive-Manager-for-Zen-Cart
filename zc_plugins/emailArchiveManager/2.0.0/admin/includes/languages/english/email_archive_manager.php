...
define('HEADING_TRIM_INSTRUCT', 'Delete emails older than...');
...
define('TEXT_TRIM_ARCHIVE', 'Trim email archive...');
...
define('TRIM_CONFIRM_WARNING', 'Warning: This will delete emails from the archive.<br>Are you sure?');
define('POPUP_CONFIRM_RESEND', 'Are you sure you want to <strong>resend</strong> this message?');
define('POPUP_CONFIRM_DELETE', 'Are you sure you want to <strong>delete</strong> this message?');
define('SUCCESS_TRIM_ARCHIVE', 'Success: Emails older than <strong>%s</strong> have been removed');
define('SUCCESS_EMAIL_RESENT', 'Success: Email #%s has been resent to %s');
