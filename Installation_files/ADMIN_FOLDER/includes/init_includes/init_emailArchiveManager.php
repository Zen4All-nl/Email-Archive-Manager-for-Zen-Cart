...
$module_constant = 'EMAIL_ARCHIVE_MANAGER_VERSION';
$module_installer_directory = DIR_FS_ADMIN . 'includes/installers/emailArchiveManager';
$module_name = 'Email Archive Manager';
$module_file_for_version_check = '';
$zencart_com_plugin_id = 101;
...
if (defined($module_constant)) {
  ...
  $db->Execute("INSERT INTO " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added, set_function)
                VALUES ('Version', '" . $module_constant . "', '0.0.0', 'Version installed:', " . (int)$configuration_group_id . ", 0, NOW(), NOW(), 'trim(');");
}
